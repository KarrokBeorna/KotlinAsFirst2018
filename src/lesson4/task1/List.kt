...
fun russianNames(n: Int): String {
    return when {
        ...
        n / 1000 % 10 == 1 -> ""
        n / 1000 % 10 == 2 -> ""
        n / 1000 % 10 in 3..4 && n % 1000 == 0 -> " тысячи"
        n / 1000 % 10 in 3..4 -> " тысячи "
        n % 1000 == 0 -> " тысяч"
        else -> " тысяч "
    }
}
...
fun russian(n: Int): String {
    ...
    for (i in 1..count) {
        ...
        when {
            ...
            k == 3 && (num % 100 != 13) -> char = "три"
            k == 4 && (num % 100 != 14) -> char = "четыре"
            k == 5 && (num % 100 != 15) -> char = "пять"
            k == 6 && (num % 100 != 16) -> char = "шесть"
            k == 7 && (num % 100 != 17) -> char = "семь"
            k == 8 && (num % 100 != 18) -> char = "восемь"
            k == 9 && (num % 100 != 19) -> char = "девять"
            ...
            k == 20 -> char = if (n % 10 == 0) "двадцать" else "двадцать "
            k == 30 -> char = if (n % 10 == 0) "тридцать" else "тридцать "
            k == 40 -> char = if (n % 10 == 0) "сорок" else "сорок "
            k == 50 -> char = if (n % 10 == 0) "пятьдесят" else "пятьдесят "
            k == 60 -> char = if (n % 10 == 0) "шестьдесят" else "шестьдесят "
            k == 70 -> char = if (n % 10 == 0) "семьдесят" else "семьдесят "
            k == 80 -> char = if (n % 10 == 0) "восемьдесят" else "восемьдесят "
            k == 90 -> char = if (n % 10 == 0) "девяносто" else "девяносто "
            k == 100 -> char = if (n % 100 == 0) "сто" else "сто "
            k == 200 -> char = if (n % 100 == 0) "двести" else "двести "
            k == 300 -> char = if (n % 100 == 0) "триста" else "триста "
            k == 400 -> char = if (n % 100 == 0) "четыреста" else "четыреста "
            k == 500 -> char = if (n % 100 == 0) "пятьсот" else "пятьсот "
            k == 600 -> char = if (n % 100 == 0) "шестьсот" else "шестьсот "
            k == 700 -> char = if (n % 100 == 0) "семьсот" else "семьсот "
            k == 800 -> char = if (n % 100 == 0) "восемьсот" else "восемьсот "
            k == 900 -> char = if (n % 100 == 0) "девятьсот" else "девятьсот "
            k == 1000 -> char = when {
                n % 1000 == 0 -> "одна тысяча"
                n > 2999 -> " одна тысяча "
                else -> "одна тысяча "
            }
            k == 2000 -> char = when {
